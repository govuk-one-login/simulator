...
const setSimulatorClientId = async (clientId) => {
...
Given("the simulator is configured with the client ID {string}", async (clientId) => {
    await setSimulatorClientId(clientId);
})
...
module.exports = { setSimulatorClientId };