...
export const openidConfigurationController = async (
  ...
  const openidConfig = {
    authorization_endpoint: `${config.getSimulatorUrl()}/authorize`,
    token_endpoint: `${config.getSimulatorUrl()}/token`,
    issuer: `${config.getIssuerValue()}`,
    jwks_uri: `${config.getSimulatorUrl()}/.well-known/jwks.json`,
    ...
    trustmarks: `${config.getTrustmarkUrl()}`,
    subject_types_supported: ["public", "pairwise"],
    userinfo_endpoint: `${config.getSimulatorUrl()}/userinfo`,
    end_session_endpoint: `${config.getSimulatorUrl()}/logout`,
